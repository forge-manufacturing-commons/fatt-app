...
export const SEED_EVENTS = [
  { id: "E01", location: "Effurun / Warri", locationCode: "WAR", actorType: "SME",         component: "Chassis crossmember",     componentCode: "CHS-XM-004", action: "Welding in progress",       status: "In progress",  target: "chassis",     tone: "fabricate", signoff: "Engr. Adebayo" },
  { id: "E02", location: "Nnewi",           locationCode: "NNW", actorType: "SME",         component: "Steering bracket",         componentCode: "STE-BR-011", action: "Fabrication complete",      status: "Complete",     target: "chassis",     tone: "accept",    signoff: "Awaiting review" },
  { id: "E03", location: "Polytechnic workshop", locationCode: "ILR", actorType: "UNI",   component: "Frame drawing",            componentCode: "FRM-DR-002", action: "Drawing check — revision received", status: "Review",       target: "engineering", tone: "review",    signoff: "Engr. Okonkwo" },
  { id: "E04", location: "Diaspora technical review", locationCode: "DSP", actorType: "DIASPORA", component: "Frame drawing",     componentCode: "FRM-DR-002", action: "Review approved",           status: "Approved",     target: "engineering", tone: "accept",    signoff: "Engr. Musa (diaspora)" },
  { id: "E05", location: "Lagos",           locationCode: "LAG", actorType: "INDUSTRY",    component: "Brake component",          componentCode: "BRK-CP-007", action: "Supplier match — source found", status: "Matched",   target: "energy",      tone: "supply",    signoff: "System match" },
  { id: "E06", location: "Forge build system", locationCode: "SYS", actorType: "SYSTEM",  component: "Component evidence",       componentCode: "EVD-018",    action: "Received for review",       status: "In review",    target: "engineering", tone: "evidence",  signoff: "Queued for review" },
  { id: "E07", location: "Aba",             locationCode: "ABA", actorType: "SME",         component: "Body trim panel",          componentCode: "BDY-TR-009", action: "Component accepted",        status: "Accepted",     target: "body",        tone: "accept",    signoff: "Engr. Chikelu" },
];
