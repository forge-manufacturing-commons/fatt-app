  ...
  return (
    <svg viewBox="0 0 1200 420" width="100%" height="100%" preserveAspectRatio="xMidYMid slice"
      ...
      <g transform="translate(250 300)">
        ...
        <text x="-70" y="44" fontFamily="var(--forge-display-font, 'Poppins', system-ui, sans-serif)" fontSize="11" fontWeight="600" letterSpacing="0.14em" fill={IVORY} opacity="0.5">WELD · WARRI</text>
      </g>
      ...
      <g transform="translate(720 300)">
        ...
        {/* measurement readout */}
        <text x="34" y="-52" fontFamily="var(--forge-display-font, 'Poppins', system-ui, sans-serif)" fontSize="12" fontWeight="700" fill={AMBER}>
          Ø 82.
          <tspan>
            <animate attributeName="opacity" values="1;0.3;1" dur="1.4s" repeatCount="indefinite" />4
          </tspan>
        </text>
        <text x="-40" y="44" fontFamily="var(--forge-display-font, 'Poppins', system-ui, sans-serif)" fontSize="11" fontWeight="600" letterSpacing="0.14em" fill={IVORY} opacity="0.5">INSPECT · LAGOS</text>
      </g>
